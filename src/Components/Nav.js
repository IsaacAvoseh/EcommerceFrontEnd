        ...
        <div className="container">
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li className="nav-item">
                <a className="nav-link anc" href="#"><i className="fas fa-phone-alt"/> { user ? '+23803926190' :'Your Number'}</a>
              </li>
            </ul>
            <ul className="navbar-nav ul1 me-auto mb-2 mb-lg-0">
              ...
              <li className="nav-item">
                <a className="nav-link anc" href="/cart"><i className="fas fa-shopping-cart" /><sup className='text-white m-1 h6' >{ totalItems }</sup ></a>
              </li>
            </ul>
          </div>
        </div>
      ...
      <div className="container">
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li className="nav-item">
              <Link to="/sidebar" className={`nav-link anc2 ${props.active3}`} >Product</Link>
            </li>
            <li className="nav-item">
          ...
          <div className="d-flex">
                <input value={props.input} className="form-control me-2" type="search" placeholder="Search" aria-label="Search" onChange={(e) => props.setInput(e.target.value)}/>
                <button className="btn btn2 btn-outline-success" type="submit"><i className="fas btn-search fa-search" onClick={()=>props.data(props.input)} /></button>
          </div>
        </div>
      </div>
    </nav>
